...
contract FractionalNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, ERC721Burnable {
    ...
    modifier onlyOwner(){
        require(msg.sender == owner, "Nao e o proprietario do NFT");
        _;
    }
...
contract FNFToken is ERC20, ERC20Burnable {
    ...
    modifier onlyOwner(){
        require(msg.sender == owner, "Nao e o proprietario do token");
        _;
    }
